...
namespace WebApplication5.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [CustomEmailValidation(ErrorMessage = "Email must not start with a numeric value or a special character.")]
            [RegularExpression("^[^0-9\\W][a-zA-Z0-9._-]*[a-zA-Z0-9]@[a-zA-Z0-9][a-zA-Z0-9.-]*[a-zA-Z0-9]\\.[a-zA-Z]{2,}$", ErrorMessage = "Invalid email format.")]
            [Display(Name = "Email")]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            //var roles = _roleManager.Roles.Where(role => role.Name != "Admin").Select(role => role.Name);
